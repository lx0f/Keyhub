!(function (e, t) {
    ...
    !(function (e, t) {
        !(function (e) {
            ...
            function n(e) {
                ...
                return (
                    1 === e.length && ((t = (t, n) => e(t) - n), (n = r(e))),
                    { left: a, center: o, right: i }
                );
            }
            function r(e) {
                return (n, r) => t(e(n), r);
            ...
            function h(e) {
                return 'object' != typeof e || 'length' in e
                    ? e
                    : Array.from(e);
            }
            function b(e) {
            ...
            function p(...e) {
                const t = 'function' == typeof e[e.length - 1] && b(e.pop()),
                    ...
                    i = [];
                if (r < 0 || n.some(d)) return i;
                for (;;) {
                    i.push(a.map((t, n) => e[n][t]));
                    let o = r;
                    for (; ++a[o] === n[o]; ) {
                        if (0 === o) return t ? i.map(t) : i;
                        a[o--] = 0;
                    }
                }
            }
            ...
            function w(e, t) {
                const n = new M();
                if (void 0 === t) for (let t of e) (t = +t) && n.add(t);
                else {
                    let r = -1;
                    for (let a of e) (a = +t(a, ++r, e)) && n.add(a);
                }
                return +n;
            }
            function S(e, t) {
            ...
            function j(e, ...t) {
                return T(e, Array.from, I, t);
            }
            function O(e, t, ...n) {
                return T(e, I, t, n);
            }
            function z(e, t, ...n) {
                return T(e, Array.from, t, n);
            }
            function D(e, ...t) {
                return T(e, I, q, t);
            }
            function R(e, ...t) {
                return T(e, Array.from, q, t);
            }
            function q(e) {
            ...
            function T(e, t, n, r) {
                return (function e(a, i) {
                    ...
                    for (const [t, n] of o) o.set(t, e(n, i));
                    return t(o);
                })(e, 0);
            }
            function G(e, t) {
            ...
            function L(e, n, r) {
                return (
                    1 === n.length
                        ? B(O(e, n, r), ([e, n], [r, a]) => t(n, a) || t(e, r))
                        : B(P(e, r), ([e, r], [a, i]) => n(r, i) || t(e, a))
                ).map(([e]) => e);
            }
            ...
            function U(e, t, n) {
                ...
                for (;;) {
                    const a = X(e, t, n);
                    if (a === r || 0 === a || !isFinite(a)) return [e, t];
                    a > 0
                        ? ((e = Math.floor(e / a) * a),
                          (t = Math.ceil(t / a) * a))
                        : a < 0 &&
            ...
            function Z() {
                ...
                function r(r) {
                    ...
                    if (!Array.isArray(d)) {
                        ...
                        if (
                            (t === x && ([l, s] = U(l, s, n)),
                            (d = Y(l, s, n))[d.length - 1] >= s)
                        )
                            if (e >= s && t === x) {
                                const e = X(l, s, n);
                                isFinite(e) &&
                                    (e > 0
                                        ? (s = (Math.floor(s / e) + 1) * e)
                                        : e < 0 &&
                                          (s = (Math.ceil(s * -e) + 1) / -e));
                            } else d.pop();
                    }
                    ...
                    var b,
                        p = new Array(h + 1);
                    for (a = 0; a <= h; ++a)
                        ((b = p[a] = []).x0 = a > 0 ? d[a - 1] : l),
                            (b.x1 = a < h ? d[a] : s);
                    for (a = 0; a < o; ++a)
                        l <= (i = c[a]) &&
                            i <= s &&
                            p[f(d, i, 0, h)].push(r[a]);
                    return p;
                }
                return (
                    (r.value = function (t) {
                        return arguments.length
                            ? ((e = 'function' == typeof t ? t : W(t)), r)
                            : e;
                    }),
                    (r.domain = function (e) {
                        return arguments.length
                            ? ((t =
                                  'function' == typeof e ? e : W([e[0], e[1]])),
                              r)
                            : t;
                    }),
                ...
                for (; a > r; ) {
                    if (a - r > 600) {
                        ...
                        te(
                            e,
                            n,
                            Math.max(r, Math.floor(n - (o * c) / t + u)),
                            Math.min(a, Math.floor(n + ((t - o) * c) / t + u)),
                            i
                        );
                    }
                    const t = e[n];
            ...
            function he(e, t = be) {
                ...
                let r,
                    a = !1;
                for (const i of e) a && n.push(t(r, i)), (r = i), (a = !0);
                return n;
            }
            function be(e, t) {
                return [e, t];
            ...
            function ge(e, n = t) {
                ...
                } else for (const t of e) (a ? n(t, r) < 0 : 0 === n(t, t)) && ((r = t), (a = !0));
                return r;
            }
            function ye(e, n = t) {
                if (1 === n.length) return de(e, n);
                let r,
                    a = -1,
                    i = -1;
                for (const t of e)
            ...
            function Ce(e, t) {
                ...
                const n = [];
                let r = -1;
                for (const a of e) t(a, ++r, e) && n.push(a);
                return n;
            }
            function Ie(e, t) {
                if ('function' != typeof e[Symbol.iterator])
            ...
            function Pe(e, t, n) {
                ...
                if (arguments.length < 3) {
                    if ((({ done: a, value: n } = r.next()), a)) return;
                    ++o;
                }
                for (; ({ done: a, value: i } = r.next()), !a; )
                    n = t(n, i, ++o, e);
                return n;
            }
            function je(e) {
    ...
    function I(e, t, n) {
        var r,
            a = -1,
            i = e.length - n;
        for (t.lineStart(); ++a < i; ) (r = e[a]), t.point(r[0], r[1], r[2]);
        t.lineEnd();
    }
    function P(e, t) {
        var n = -1,
            r = e.length;
        for (t.polygonStart(); ++n < r; ) I(e[n], t, 1);
        t.polygonEnd();
    }
    function j(e, t) {
    ...
    function U(e, t, n, r, a) {
        ...
        if (
            ...
            for (c.sort(t), Q(f), Q(c), i = 0, o = c.length; i < o; ++i)
                c[i].e = n = !n;
            for (var u, l, s = f[0]; ; ) {
                for (var d = s, h = !0; d.v; ) if ((d = d.n) === s) return;
                (u = d.z), a.lineStart();
                do {
                    if (((d.v = d.o.v = !0), d.e)) {
                        if (h)
    ...
    function Z(e) {
        return d(e[0]) <= o ? e[0] : M(e[0]) * (((d(e[0]) + o) % u) - o);
    }
    function J(e, t) {
        var n = Z(t),
            i = t[1],
            ...
            function x() {
                ...
                if ((c.pop(), o.push(c), (c = null), h))
                    if (1 & a) {
                        ...
                        h > 1 && 2 & a && u.push(u.pop().concat(u.shift())),
                            f.push(u.filter(te));
            }
            return h;
        };
    ...
    function ne(e, t) {
        return (
            ((e = e.x)[0] < 0 ? e[1] - f - a : f - e[1]) -
            ((t = t.x)[0] < 0 ? t[1] - f - a : f - t[1])
        );
    }
    new r.exports.Adder(), new r.exports.Adder(), (L.invert = L);
    var re = ee(
        function () {
            return !0;
        },
        ...
        function (e, t, n, r) {
            ...
            if (null == e)
                ...
                var c = e[0] < t[0] ? o : -o;
                (i = (n * c) / 2), r.point(-c, i), r.point(0, i), r.point(c, i);
        ...
        return function (a) {
            var c,
                ...
                w = {
                    point: S,
                    lineStart: function () {
                        (w.point = E), l && l.push((s = []));
                        (v = !0), (y = !1), (p = g = NaN);
                    },
                    lineEnd: function () {
                        c &&
                            (E(d, h), b && y && M.rejoin(), c.push(M.result()));
                        (w.point = S), y && x.lineEnd();
                    },
                    polygonStart: function () {
                        (x = M), (c = []), (l = []), (m = !0);
                    },
            ...
            function E(r, a) {
                ...
                if ((l && s.push([r, a]), v))
                    (d = r),
                        ...
                        (b = f),
                        (v = !1),
                        f && (x.lineStart(), x.point(r, a));
                else if (f && y) x.point(r, a);
                else {
                    var c = [
                            (p = Math.max(le, Math.min(ue, p))),
                            (g = Math.max(le, Math.min(ue, g))),
                        ],
                        u = [
                            (r = Math.max(le, Math.min(ue, r))),
                            (a = Math.max(le, Math.min(ue, a))),
                        ];
                    !(function (e, t, n, r, a, i) {
                        var o,
                            f = e[0],
                        ...
                        ? f && (x.lineStart(), x.point(r, a), (m = !1))
                        : (y || (x.lineStart(), x.point(c[0], c[1])),
                          x.point(u[0], u[1]),
                          f || x.lineEnd(),
                          (m = !1));
                }
    ...
    function be(e, t) {
        (oe = e *= s), (fe = x((t *= s))), (ce = p(t)), (de.point = pe);
    }
    function pe(e, t) {
        e *= s;
        var n = x((t *= s)),
            ...
            f = ce * n - fe * r * i,
            c = fe * n + ce * r * i;
        ie.add(b(w(o * o + f * f), c)), (oe = e), (fe = n), (ce = r);
    }
    var ge = [null, null],
        ye = { type: 'LineString', coordinates: ge };
    function ve(e, t) {
        return (
            (ge[0] = e),
            (ge[1] = t),
            (function (e) {
                return (ie = new r.exports.Adder()), j(e, de), +ie;
            })(ye)
        );
    }
    var me = {
            Feature: function (e, t) {
                return Me(e.geometry, t);
            },
            FeatureCollection: function (e, t) {
                for (var n = e.features, r = -1, a = n.length; ++r < a; )
                    if (Me(n[r].geometry, t)) return !0;
                return !1;
            },
        },
        xe = {
            ...
            Point: function (e, t) {
                return we(e.coordinates, t);
            },
            MultiPoint: function (e, t) {
                for (var n = e.coordinates, r = -1, a = n.length; ++r < a; )
                    if (we(n[r], t)) return !0;
                return !1;
            },
            LineString: function (e, t) {
    ...
    function Se(e, t) {
        for (var n, r, a, o = 0, f = e.length; o < f; o++) {
            if (0 === (r = ve(e[o], t))) return !0;
            if (
                o > 0 &&
                (a = ve(e[o], e[o - 1])) > 0 &&
                n <= a &&
                r <= a &&
                (n + r - a) * (1 - Math.pow((n - r) / a, 2)) < i * a
            )
                return !0;
            n = r;
        }
    ...
    function Ce() {
        ...
        function w() {
            return r.exports
                .range(g(i / v) * v, n, v)
                .map(h)
                .concat(r.exports.range(g(u / m) * m, c, m).map(b))
                .concat(
                    r.exports
                        .range(g(t / p) * p, e, p)
                        .filter(function (e) {
        ...
        return (
            ...
            (M.extent = function (e) {
                return arguments.length
                    ? M.extentMajor(e).extentMinor(e)
                    : M.extentMinor();
            }),
            (M.extentMajor = function (e) {
                return arguments.length
                    ? ((i = +e[0][0]),
                      (n = +e[1][0]),
                      (u = +e[0][1]),
            ...
            (M.step = function (e) {
                return arguments.length
                    ? M.stepMajor(e).stepMinor(e)
                    : M.stepMinor();
            }),
            (M.stepMajor = function (e) {
                return arguments.length
                    ? ((v = +e[0]), (m = +e[1]), M)
                    : [v, m];
            }),
            (M.stepMinor = function (e) {
                return arguments.length
                    ? ((p = +e[0]), (y = +e[1]), M)
                    : [p, y];
            }),
    ...
    var Ie,
        ...
        qe = {
            ...
            lineEnd: N,
            polygonStart: function () {
                (qe.lineStart = Te), (qe.lineEnd = Le);
            },
            polygonEnd: function () {
                (qe.lineStart = qe.lineEnd = qe.point = N),
                    De.add(d(Re)),
                    (Re = new r.exports.Adder());
            },
            result: function () {
                var e = De / 2;
                return (De = new r.exports.Adder()), e;
            },
        };
    function Te() {
        qe.point = Ge;
    ...
    function Ge(e, t) {
        (qe.point = Be), (Ie = je = e), (Pe = Oe = t);
    }
    function Be(e, t) {
        Re.add(Oe * e - je * t), (je = e), (Oe = t);
    }
    function Le() {
        Be(Ie, Pe);
    }
    ...
    var Ye,
        ...
        ot = {
            ...
            lineEnd: st,
            polygonStart: function () {
                (ot.lineStart = dt), (ot.lineEnd = ht);
            },
            polygonEnd: function () {
                (ot.point = ft), (ot.lineStart = ct), (ot.lineEnd = st);
            },
            result: function () {
                var e = it
                    ? [rt / it, at / it]
                    ...
                    ? [Qe / Je, Ze / Je]
                    : [NaN, NaN];
                return (Qe = Ze = Je = et = tt = nt = rt = at = it = 0), e;
            },
        };
    function ft(e, t) {
        (Qe += e), (Ze += t), ++Je;
    ...
    function bt(e, t) {
        (ot.point = pt), ft((Ye = Ke = e), (Xe = Ue = t));
    }
    function pt(e, t) {
        var n = e - Ke,
            r = t - Ue,
    ...
    var yt,
        ...
        St = {
            ...
            result: function () {
                var e = +wt;
                return (wt = new r.exports.Adder()), e;
            },
        };
    function Et(e, t) {
        (St.point = At), (vt = xt = e), (mt = Mt = t);
    }
    function At(e, t) {
        (xt -= e), (Mt -= t), wt.add(w(xt * xt + Mt * Mt)), (xt = e), (Mt = t);
    }
    function Nt() {
        this._string = [];
    }
    ...
    function kt(e, t) {
        ...
        return (
            (i.area = function (e) {
                return j(e, n(qe)), qe.result();
            }),
            (i.measure = function (e) {
                return j(e, n(St)), St.result();
            }),
            (i.bounds = function (e) {
                return j(e, n(He)), He.result();
            }),
            (i.centroid = function (e) {
                return j(e, n(ot)), ot.result();
            }),
            (i.projection = function (t) {
                return arguments.length
                    ? ((n = null == t ? ((e = null), ze) : (e = t).stream), i)
                    : e;
            }),
            (i.context = function (e) {
                return arguments.length
                    ? ((r =
                          null == e ? ((t = null), new Nt()) : new gt((t = e))),
            ...
            (i.pointRadius = function (e) {
                return arguments.length
                    ? ((a =
                          'function' == typeof e ? e : (r.pointRadius(+e), +e)),
                      i)
                    : a;
            }),
        ...
        point: function (e, t) {
            switch (this._point) {
                ...
                case 1:
                    ...
                    break;
                default:
                    null == this._circle && (this._circle = _t(this._radius)),
                  ...
                  return function (t) {
                      var r,
                          ...
                          p = {
                              ...
                              lineEnd: m,
                              polygonStart: function () {
                                  t.polygonStart(), (p.lineStart = x);
                              },
                              polygonEnd: function () {
                                  t.polygonEnd(), (p.lineStart = y);
                              },
                          };
                      function g(n, r) {
    ...
    function Lt(e) {
        ...
        function j() {
            var e = Gt(h, 0, 0, S, E, M).apply(null, t(g, y)),
                r = Gt(h, b - e[0], p - e[1], S, E, M);
            return (
                (n = F(v, m, x)),
                (f = B(t, r)),
                (c = B(n, f)),
        ...
        return (
            ...
            (I.rotate = function (e) {
                return arguments.length
                    ? ((v = (e[0] % 360) * s),
                      (m = (e[1] % 360) * s),
                      (x = e.length > 2 ? (e[2] % 360) * s : 0),
                      j())
                    : [v * l, m * l, x * l];
            }),
            (I.angle = function (e) {
                return arguments.length ? ((M = (e % 360) * s), j()) : M * l;
            }),
    ...
    function Vt() {
        return Ft(Wt).scale(155.424).center([0, 33.6442]);
    }
    function $t() {
        return Vt()
            .parallels([29.5, 45.5])
    ...
    function Ht() {
        var e,
            ...
            o,
            f = $t(),
            c = Vt().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
            u = Vt().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]),
            l = {
                point: function (e, t) {
                    o = [e, t];
                },
        ...
        return (
            ...
            (s.stream = function (n) {
                return e && t === n
                    ? e
                    : ((r = [f.stream((t = n)), c.stream(n), u.stream(n)]),
                      (a = r.length),
                      (e = {
                          point: function (e, t) {
                              for (var n = -1; ++n < a; ) r[n].point(e, t);
                          },
                          sphere: function () {
                              for (var e = -1; ++e < a; ) r[e].sphere();
                          },
                          lineStart: function () {
                              for (var e = -1; ++e < a; ) r[e].lineStart();
                          },
                          lineEnd: function () {
                              for (var e = -1; ++e < a; ) r[e].lineEnd();
                          },
                          polygonStart: function () {
                              for (var e = -1; ++e < a; ) r[e].polygonStart();
                          },
                          polygonEnd: function () {
                              for (var e = -1; ++e < a; ) r[e].polygonEnd();
                          },
                      }));
                var r, a;
            }),
            (s.precision = function (e) {
                return arguments.length
                    ? (f.precision(e), c.precision(e), u.precision(e), d())
                    : f.precision();
            }),
            (s.scale = function (e) {
                return arguments.length
            ...
            (s.translate = function (e) {
                ...
                return (
                    ...
                    (r = c
                        ...
                        .clipExtent([
                            [o - 0.425 * t + a, s + 0.12 * t + a],
                            [o - 0.214 * t - a, s + 0.234 * t - a],
                        ])
                        .stream(l)),
                    (i = u
                        .translate([o - 0.205 * t, s + 0.212 * t])
                        .clipExtent([
                            [o - 0.214 * t + a, s + 0.166 * t + a],
                            [o - 0.115 * t - a, s + 0.234 * t - a],
                        ])
                        .stream(l)),
                    d()
                );
    ...
    function Ut() {
        return Bt(Kt).scale(124.75).clipAngle(179.999);
    }
    Kt.invert = Xt(function (e) {
        return 2 * A(e / 2);
    });
    var Qt = Yt(function (e) {
        return (e = E(e)) && e / x(e);
    });
    function Zt() {
        return Bt(Qt).scale(79.4188).clipAngle(179.999);
    }
    function Jt(e, t) {
        return [e, v(S((f + t) / 2))];
    }
    function en() {
        return tn(Jt).scale(961 / u);
    }
    function tn(e) {
        var t,
            n,
    ...
    function an() {
        return Ft(rn).scale(109.5).parallels([30, 30]);
    }
    function on(e, t) {
        return [e, t];
    }
    function fn() {
        return Bt(on).scale(152.63);
    }
    function cn(e, t) {
        var n = p(e),
            r = e === t ? x(e) : (n - p(t)) / (t - e),
    ...
    function un() {
        return Ft(cn).scale(131.154).center([0, 13.9389]);
    }
    (Qt.invert = Xt(function (e) {
        return e;
    })),
    ...
    function pn(e, t) {
        var n = A(bn * x(t)),
            ...
            a = r * r * r;
        return [
            (e * p(n)) / (bn * (ln + 3 * sn * r + a * (7 * dn + 9 * hn * r))),
            n * (ln + sn * r + a * (dn + hn * r)),
        ];
    }
    function gn() {
        return Bt(pn).scale(177.158);
    }
    function yn(e, t) {
        var n = p(t),
            r = p(e) * n;
    ...
    function vn() {
        return Bt(yn).scale(144.049).clipAngle(60);
    }
    function mn(e, t) {
        var n = t * t,
            r = n * n;
        return [
            ...
            t *
                (1.007226 +
                    n *
                        (0.015085 +
                            r * (0.028874 * n - 0.044475 - 0.005916 * r))),
        ];
    }
    function xn() {
        return Bt(mn).scale(175.295);
    }
    function Mn(e, t) {
        return [p(t) * x(e), x(t)];
    }
    function wn() {
        return Bt(Mn).scale(249.5).clipAngle(90.000001);
    }
    function Sn(e, t) {
        var n = p(t),
            r = 1 + p(e) * n;
    ...
    function En() {
        return Bt(Sn).scale(250).clipAngle(142);
    }
    function An(e, t) {
        return [v(S((f + t) / 2)), -e];
    }
    ...
    (pn.invert = function (e, t) {
        for (
            var n, r = t, a = r * r, o = a * a * a, f = 0;
            f < 12 &&
            ((o =
                (a =
                    (r -= n =
                        (r * (ln + sn * a + o * (dn + hn * a)) - t) /
                        (ln + 3 * sn * a + o * (7 * dn + 9 * hn * a))) * r) *
                a *
                a),
            !(d(n) < i));
            ++f
        ...
        return [
            (bn * e * (ln + 3 * sn * a + o * (7 * dn + 9 * hn * a))) / p(r),
            A(x(r) / bn),
        ];
    }),
        (yn.invert = Xt(h)),
        ...
        (Mn.invert = Xt(A)),
        (Sn.invert = Xt(function (e) {
            return 2 * h(e);
        })),
        (An.invert = function (e, t) {
            return [-t, 2 * h(y(e)) - f];
        });
    const _n = {
        geoAzimuthalEqualArea: Ut,
        geoAzimuthalEquidistant: Zt,
        geoGnomonic: vn,
        geoOrthographic: wn,
        geoStereographic: En,
        geoEqualEarth: gn,
        geoAlbers: $t,
        geoAlbersUsa: Ht,
        geoConicConformal: an,
        geoConicEqualArea: Vt,
        geoConicEquidistant: un,
        geoEquirectangular: fn,
        geoMercator: en,
        geoTransverseMercator: Nn,
        geoNaturalEarth1: xn,
    };
    Object.keys(_n).forEach((e) => {
        _n[`${e.charAt(3).toLowerCase()}${e.slice(4)}`] = _n[e];
    });
    class kn extends t.Scale {
        constructor(e) {
            super(e),
        ...
        init(e) {
            (e.position = 'chartArea'),
                ...
                'function' == typeof e.projection
                    ...
                    : (this.projection = (_n[e.projection] || _n.albersUsa)()),
                this.geoPath.projection(this.projection),
                (this.outlineBounds = null),
                (this.oldChartBounds = null);
        }
        computeBounds(e) {
            const t = kt(this.projection.fitWidth(1e3, e)).bounds(e),
        ...
        updateBounds() {
            ...
            const n = this.options.padding,
                r = 'number' == typeof n ? n : n.top,
                a = 'number' == typeof n ? n : n.left,
                i = 'number' == typeof n ? n : n.bottom,
                o = 'number' == typeof n ? n : n.right,
                f = e.right - e.left - a - o,
                c = e.bottom - e.top - r - i,
                u = this.oldChartBounds;
            this.oldChartBounds = { chartWidth: f, chartHeight: c };
            const l = Math.min(f / t.width, c / t.height),
                s = t.width * l,
                d = t.height * l,
                h = 0.5 * (f - s) + e.left + a,
                b = 0.5 * (c - d) + e.top + r,
            ...
            return (
                this.projection
                    .scale(t.refScale * l * p.projectionScale)
                    .translate([
                        l * t.refX + h + p.projectionOffset[0],
                        l * t.refY + b + p.projectionOffset[1],
                    ]),
                !u ||
                    u.chartWidth !== this.oldChartBounds.chartWidth ||
                    u.chartHeight !== this.oldChartBounds.chartHeight
            );
        }
    }
    function Cn(e) {
    ...
    (kn.id = 'projection'),
        ...
        Cn('1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf'),
        Cn('7fc97fbeaed4fdc086ffff99386cb0f0027fbf5b17666666'),
        Cn('1b9e77d95f027570b3e7298a66a61ee6ab02a6761d666666'),
        Cn(
            'a6cee31f78b4b2df8a33a02cfb9a99e31a1cfdbf6fff7f00cab2d66a3d9affff99b15928'
        ),
        Cn('fbb4aeb3cde3ccebc5decbe4fed9a6ffffcce5d8bdfddaecf2f2f2'),
        Cn('b3e2cdfdcdaccbd5e8f4cae4e6f5c9fff2aef1e2cccccccc'),
        Cn('e41a1c377eb84daf4a984ea3ff7f00ffff33a65628f781bf999999'),
        Cn('66c2a5fc8d628da0cbe78ac3a6d854ffd92fe5c494b3b3b3'),
        Cn(
            '8dd3c7ffffb3bebadafb807280b1d3fdb462b3de69fccde5d9d9d9bc80bdccebc5ffed6f'
        ),
        Cn('4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab');
    var In,
        Pn = { exports: {} },
        jn = { exports: {} };
    function On() {
            ...
            In ||
                ...
                (function (e, t) {
                    !(function (e) {
                        ...
                        function w(e, t, n, r) {
                            return (
                                r <= 0 && (e = t = n = NaN), new A(e, t, n, r)
                            );
                        }
                        function S(e) {
                            return (
                                e instanceof r || (e = x(e)),
                                e
                                    ? new A(
                                          (e = e.rgb()).r,
                                          e.g,
                        ...
                        function J(e, t, n, r) {
                            return 1 === arguments.length
                                ? Z(e)
                                : new te(n, t, e, null == r ? 1 : r);
                        }
                        function ee(e, t, n, r) {
                            return 1 === arguments.length
                                ? Z(e)
                                : new te(e, t, n, null == r ? 1 : r);
                        }
                        function te(e, t, n, r) {
                            (this.h = +e),
                                (this.c = +t),
                        ...
                        function ne(e) {
                            if (isNaN(e.h)) return new Y(e.l, 0, 0, e.opacity);
                            var t = e.h * z;
                            return new Y(
                                e.l,
                                Math.cos(t) * e.c,
        ...
        !(function (e, t) {
            ...
            function N(e, t) {
                var n,
                    r,
                    a,
                    i = (w.lastIndex = S.lastIndex = 0),
                    o = -1,
                    f = [],
                    c = [];
                for (e += '', t += ''; (n = w.exec(e)) && (r = S.exec(t)); )
                    (a = r.index) > i &&
                        ((a = t.slice(i, a)),
                        f[o] ? (f[o] += a) : (f[++o] = a)),
                        (n = n[0]) === (r = r[0])
                            ? f[o]
                                ? (f[o] += r)
                                : (f[++o] = r)
                            : ((f[++o] = null), c.push({ i: o, x: x(n, r) })),
                        (i = S.lastIndex);
                return (
                    i < t.length &&
                        ((a = t.slice(i)), f[o] ? (f[o] += a) : (f[++o] = a)),
                    f.length < 2
                        ? c[0]
                            ? A(c[0].x)
                            : E(t)
            ...
            function R(e) {
                return null == e
                    ...
                    : (P ||
                      ...
                      (e = P.transform.baseVal.consolidate())
            ...
            var V = (function e(t, n, r) {
                function a(e, a) {
                    ...
                    return (i.duration = (1e3 * o * t) / Math.SQRT2), i;
                }
                return (
                    (a.rho = function (t) {
            ...
            (e.interpolate = _),
                ...
                (e.interpolateTransformCss = T),
                (e.interpolateTransformSvg = G),
                (e.interpolateZoom = V),
                (e.piecewise = te),
                (e.quantize = ne),
                Object.defineProperty(e, '__esModule', { value: !0 });
    ...
    var zn = (e) => Pn.exports.interpolateRgbBasis(e[e.length - 1]),
        Dn = zn(
            new Array(3)
                .concat(
                    'd8b365f5f5f55ab4ac',
    ...
    var cr = On(),
        ur = Pn.exports.interpolateCubehelixLong(
            cr.cubehelix(300, 0.5, 0),
            cr.cubehelix(-240, 0.5, 1)
        ),
        lr = Pn.exports.interpolateCubehelixLong(
            cr.cubehelix(-100, 0.75, 0.35),
            cr.cubehelix(80, 1.5, 0.8)
        ),
        sr = Pn.exports.interpolateCubehelixLong(
            cr.cubehelix(260, 0.75, 0.35),
            cr.cubehelix(80, 1.5, 0.8)
        ),
        dr = cr.cubehelix();
    var hr = cr.rgb(),
    ...
    class wr extends t.LinearScale {
        constructor() {
        ...
        update(e, t, n) {
            const r = Math.min(
                ...
                f = (e, t) => (e < 1 ? t * e : e),
                c =
                    Math.min(a, f(o ? i.length : i.width, a)) -
                    (o ? 0 : i.indicatorWidth),
                u =
                    Math.min(r, f(o ? i.width : i.length, r)) -
                    (o ? i.indicatorWidth : 0);
            (this.legendSize = { w: c, h: u }),
                (this.bottom = u),
                (this.height = u),
                (this.right = c),
                (this.width = c);
        ...
        draw(e) {
            ...
            const t = (function (e, t, n, r, a) {
                    const { indicatorWidth: i, align: o, position: f } = t,
                        c = 'top' === o || 'bottom' === o,
                        ...
                        s = (function (e) {
                            ...
                            return {
                                left:
                                    ('number' == typeof r ? r : r.left) +
                                    ('right' === n ? t : 0),
                                top:
                                    ('number' == typeof r ? r : r.top) +
                                    ('bottom' === n ? t : 0),
                                right:
                                    ('number' == typeof r ? r : r.right) +
                                    ('left' === n ? t : 0),
                                bottom:
                                    ('number' == typeof r ? r : r.bottom) +
                                    ('top' === n ? t : 0),
                            };
                        })(t);
                    if ('string' == typeof f)
            ...
            const { indicatorWidth: a } = this.options.legend;
    ...
    class Sr extends t.LogarithmicScale {
        constructor() {
            super(...arguments), (this.legendSize = { w: 0, h: 0 });
        }
        init(e) {
            wr.prototype.init.call(this, e);
        }
        parse(e, t) {
            return wr.prototype.parse.call(this, e, t);
        }
        isHorizontal() {
            return (
                'top' === this.options.legend.align ||
        ...
        update(e, t, n) {
            return wr.prototype.update.call(this, e, t, n);
        }
        _computeLabelArea() {}
        draw(e) {
            return wr.prototype.draw.call(this, e);
        }
        _drawIndicator() {}
    }
    const Er = {
        ...
        interpolateCool: sr,
        interpolateCubehelixDefault: ur,
        interpolateGnBu: Hn,
        interpolateGreens: rr,
        interpolateGreys: ar,
        interpolateInferno: mr,
        interpolateMagma: vr,
        interpolateOrRd: Yn,
        interpolateOranges: fr,
        interpolatePRGn: Rn,
        interpolatePiYG: qn,
        interpolatePlasma: xr,
        interpolatePuBu: Kn,
        interpolatePuBuGn: Xn,
        interpolatePuOr: Tn,
        interpolatePuRd: Un,
        interpolatePurples: ir,
        ...
        interpolateRdGy: Bn,
        interpolateRdPu: Qn,
        interpolateRdYlBu: Ln,
        interpolateRdYlGn: Fn,
        interpolateReds: or,
        interpolateSinebow: function (e) {
            var t;
            return (
                (e = (0.5 - e) * Math.PI),
                (hr.r = 255 * (t = Math.sin(e)) * t),
                (hr.g = 255 * (t = Math.sin(e + br)) * t),
                (hr.b = 255 * (t = Math.sin(e + pr)) * t),
                hr + ''
            );
        },
        interpolateSpectral: Wn,
        ...
        interpolateViridis: yr,
        interpolateWarm: lr,
        interpolateYlGn: Jn,
        interpolateYlGnBu: Zn,
        interpolateYlOrBr: er,
        interpolateYlOrRd: tr,
    };
    function Ar(e, t) {
        const n = 1 / t;
        if (e <= n) return 0;
    ...
    Object.keys(Er).forEach((e) => {
        (Er[`${e.charAt(11).toLowerCase()}${e.slice(12)}`] = Er[e]),
            (Er[e.slice(11)] = Er[e]);
    });
    const Nr = { interpolate: 'blues', missing: 'transparent', quantize: 0 };
    class _r extends wr {
        get interpolate() {
        ...
        getColor(e) {
            let t = e;
            return (
                this.options.quantize > 0 && (t = Ar(t, this.options.quantize)),
                this.interpolate(t)
            );
        }
        _drawIndicator() {
            ...
            if (this.isHorizontal()) {
                ...
                if (this.options.quantize > 0) {
                    ...
                    for (let t = 0; t < n; t += 1)
                        (this.ctx.fillStyle = this.getColor((t + 0.5) / n)),
                            this.ctx.fillRect(0, r(t), e, 1);
                }
            }
        }
    }
    (_r.id = 'color'),
        (_r.defaults = n.merge({}, [t.LinearScale.defaults, Mr, Nr])),
        (_r.descriptors = {
    ...
    class kr extends Sr {
        ...
        init(e) {
            super.init(e),
                'function' == typeof e.interpolate
                    ...
                    : (this.interpolate = Er[e.interpolate] || Er.blues);
        }
        getColorForValue(e) {
            return _r.prototype.getColorForValue.call(this, e);
        }
        getColor(e) {
            let t = e;
            return (
        ...
        _drawIndicator() {
            return _r.prototype._drawIndicator.call(this);
        }
    }
    (kr.id = 'colorLogarithmic'),
        (kr.defaults = n.merge({}, [t.LogarithmicScale.defaults, Mr, Nr])),
        (kr.descriptors = {
            _scriptable: (e) => 'interpolate' !== e,
            _indexable: !1,
        });
    ...
    (Ir.id = 'size'),
        (Ir.defaults = n.merge({}, [t.LinearScale.defaults, Mr, Cr])),
        (Ir.descriptors = {
            _scriptable: !0,
    ...
    class Pr extends Sr {
        ...
        getSizeImpl(e) {
            return Ir.prototype.getSizeImpl.call(this, e);
        }
        _drawIndicator() {
            Ir.prototype._drawIndicator.call(this);
        }
    }
    (Pr.id = 'sizeLogarithmic'),
        (Pr.defaults = n.merge({}, [t.LogarithmicScale.defaults, Mr, Cr]));
    class jr extends t.Element {
        constructor() {
        ...
        inRange(e, t) {
            ...
            if (
                ...
                return (
                    ...
                    (function (e, t) {
                        return (
                            e && me.hasOwnProperty(e.type) ? me[e.type] : Me
                        )(e, t);
                    })(this.feature, n)
                );
            }
        ...
        _drawInCache(e) {
            ...
            const n =
                ...
                o = Math.ceil(t.y + t.height),
                f = this.pixelRatio || 1;
            (n.width = Math.max(i - r, 1) * f),
                (n.height = Math.max(o - a, 1) * f);
        ...
        _drawImpl(e) {
            ...
            e.beginPath(),
                ...
                n.backgroundColor &&
                    ((e.fillStyle = n.backgroundColor), e.fill()),
                n.borderColor &&
        ...
        draw(e) {
            ...
            if (this.cache && this.cache.canvas) {
                const t = Math.floor(n.x),
                    r = Math.floor(n.y),
                    a = Math.ceil(n.x + n.width),
                    i = Math.ceil(n.y + n.height);
                e.drawImage(this.cache.canvas, t, r, a - t, i - r);
    ...
    const Or = { showOutline: !1, showGraticule: !1, clipMap: !0 },
        zr = {
            scales: { xy: { type: kn.id, position: 'chartArea', display: !1 } },
        };
    function Dr(e) {
        const t = { ...e };
        return (
    ...
    class Rr extends t.DatasetController {
        getGeoDataset() {
        ...
        update(e) {
            ...
            if (this.showOutline()) {
                ...
                if (
                    (r && delete a.cache,
                    (a.projectionScale = n),
                    (a.pixelRatio = this.chart.currentDevicePixelRatio),
                    'resize' !== e)
                ) {
                    const n = Dr(this.resolveDatasetElementOptions(e)),
                        r = { feature: this.resolveOutline(), options: n };
                    this.updateElement(a, void 0, r, e),
                        this.getGraticule() && (t.graticule = n);
                }
            } else this.getGraticule() && 'resize' !== e && (t.graticule = Dr(this.resolveDatasetElementOptions(e)));
        ...
        draw() {
            ...
            (!0 !== t && 'outline' !== t && 'outline+graticule' !== t) ||
                ((r = !0), n.clipArea(e.ctx, e.chartArea)),
                this.showOutline() &&
                ...
                !0 === t || 'graticule' === t || 'outline+graticule' === t
                    ? r || n.clipArea(e.ctx, e.chartArea)
                    : r && ((r = !1), n.unclipArea(e.ctx)),
                this.showGraticule(),
                !0 === t || 'items' === t
                    ? r || n.clipArea(e.ctx, e.chartArea)
                    : r && ((r = !1), n.unclipArea(e.ctx)),
                this.getMeta().data.forEach((t) =>
                    t.draw.call(t, e.ctx, e.chartArea)
                ),
                r && ((r = !1), n.unclipArea(e.ctx));
        }
    }
    function qr(e, n, r, a = [], i = []) {
        t.registry.addControllers(r),
            Array.isArray(a)
                ? t.registry.addElements(...a)
                : t.registry.addElements(a),
            Array.isArray(i)
                ? t.registry.addScales(...i)
                : t.registry.addScales(i);
        const o = n;
        return (o.type = e), o;
    }
    class Tr extends Rr {
        ...
        parse(e, t) {
            const n = this.getMeta().rScale,
                { data: r } = this.getDataset(),
                a = this._cachedMeta;
            for (let i = e; i < e + t; i += 1)
                a._parsed[i] = { [n.axis]: n.parse(r[i], i) };
        }
    ...
    (Tr.id = 'choropleth'),
        (Tr.defaults = n.merge({}, [
            Or,
            { datasetElementType: jr.id, dataElementType: jr.id },
        ])),
        (Tr.overrides = n.merge({}, [
            zr,
            {
                plugins: {
                    tooltip: {
                ...
                scales: { color: { type: _r.id } },
                elements: {
                    geoFeature: {
                        backgroundColor(e) {
                            if (null == e.dataIndex) return null;
                            return e.chart
    ...
    class Gr extends t.Chart {
        constructor(e, t) {
            super(e, qr('choropleth', t, Tr, jr, [_r, kn]));
        }
    }
    Gr.id = Tr.id;
    class Br extends Rr {
        ...
        updateElements(e, t, n, r) {
            ...
            for (let i = t; i < t + n; i += 1) {
                ...
                f &&
                    ((l.options = o || this.resolveDataElementOptions(i, r)),
                    a && (l.options.radius = 0)),
    ...
    (Br.id = 'bubbleMap'),
        (Br.defaults = n.merge({}, [
            Or,
            {
                ...
                datasetElementType: jr.id,
                showOutline: !0,
                clipMap: 'outline+graticule',
            },
        ])),
        (Br.overrides = n.merge({}, [
            zr,
            {
                plugins: {
                    tooltip: {
    ...
    class Lr extends t.Chart {
        constructor(e, t) {
            super(e, qr('bubbleMap', t, Br, jr, [Ir, kn]));
        }
    }
    function Fr(e) {
        return e;
    ...
    function $r(e, t) {
        ...
        return null == n && null == r
            ...
            : null == r
            ? { type: 'Feature', id: n, properties: a, geometry: i }
            : { type: 'Feature', id: n, bbox: r, properties: a, geometry: i };
    }
    function Hr(e, t) {
        var n = Wr(e.transform),
            r = e.arcs;
        function a(e, t) {
            t.length && t.pop();
    ...
    function Yr(e, t) {
        ...
        return (
            ...
            t.forEach(function (t) {
                ...
                else r[((n = [t]).start = f)] = a[(n.end = c)] = n;
            }),
            f(a, r),
            f(r, a),
    ...
    function Xr(e, t, n) {
        var r, a, i;
        if (arguments.length > 1) r = Kr(e, t, n);
        else
            for (a = 0, r = new Array((i = e.arcs.length)); a < i; ++a)
                r[a] = a;
        return { type: 'MultiLineString', arcs: Yr(e, r) };
    }
    function Kr(e, t, n) {
        var r,
            a = [],
    ...
    function Ur(e, t) {
        ...
        function o(t) {
            return (function (e) {
                for (
                    var t, n = -1, r = e.length, a = e[r - 1], i = 0;
                    ++n < r;

                )
                    (t = a), (a = e[n]), (i += t[0] * a[1] - t[1] * a[0]);
                return Math.abs(i);
            })(Hr(e, { type: 'Polygon', arcs: [t] }).coordinates[0]);
        }
        return (
    ...
    var Jr = Object.freeze({
        ...
        mesh: function (e) {
            return Hr(e, Xr.apply(this, arguments));
        },
        meshArcs: Xr,
        merge: function (e) {
            return Hr(e, Ur.apply(this, arguments));
        },
        mergeArcs: Ur,
                ...
                for (var f = t[o], c = f.length, u = 0; u < c; ++u)
                    for (var l = u + 1; l < c; ++l) {
                        var s,
                            d = f[u],
                            h = f[l];
                        (s = n[d])[(o = Qr(s, h))] !== h && s.splice(o, 0, h),
                            (s = n[h])[(o = Qr(s, d))] !== d &&
                                s.splice(o, 0, d);
                    }
            return n;
            ...
            function h(e) {
                ...
                switch (e.type) {
                    case 'GeometryCollection':
                        ...
                        break;
                    case 'Point':
                        t = { type: 'Point', coordinates: d(e.coordinates) };
                        break;
                    case 'MultiPoint':
                        t = {
                            type: 'MultiPoint',
    ...
    t.registry.addScales(kr, Pr, kn, _r, Ir),
        t.registry.addElements(jr),
        t.registry.addControllers(Tr, Br),
        (e.BubbleMapChart = Lr),
        (e.BubbleMapController = Br),
        (e.ChoroplethChart = Gr),
        (e.ChoroplethController = Tr),
        (e.ColorLogarithmicScale = kr),
        (e.ColorScale = _r),
        (e.GeoController = Rr),
        (e.GeoFeature = jr),
        (e.ProjectionScale = kn),
        (e.SizeLogarithmicScale = Pr),
        (e.SizeScale = Ir),
        (e.geoAlbers = $t),
        (e.geoAlbersUsa = Ht),
        (e.geoAzimuthalEqualArea = Ut),
        (e.geoAzimuthalEquidistant = Zt),
        (e.geoConicConformal = an),
        (e.geoConicEqualArea = Vt),
        (e.geoConicEquidistant = un),
        (e.geoEqualEarth = gn),
        (e.geoEquirectangular = fn),
        (e.geoGnomonic = vn),
        (e.geoMercator = en),
        (e.geoNaturalEarth1 = xn),
        (e.geoOrthographic = wn),
        (e.geoStereographic = En),
        (e.geoTransverseMercator = Nn),
        (e.topojson = Jr),
        Object.defineProperty(e, '__esModule', { value: !0 });
});
